...
class PdfRewriteService
{
    ...
    public function buildAvizHtml(array $aviz, array $company, array $meta = []): string
    {
        ...
        return '<!doctype html>'
            ...
            . '.items-wrap{margin-top:12px;width:86%;max-width:900px;}'
            ...
            . '.items-table th{background:#f1f5f9;text-align:left;white-space:nowrap;}'
            . '.items-table th:nth-child(1),.items-table td:nth-child(1){width:34px;}'
            . '.items-table th:nth-child(2),.items-table td:nth-child(2){width:38%;white-space:normal;word-break:break-word;}'
            . '.items-table th:nth-child(3),.items-table td:nth-child(3){width:58px;}'
            . '.items-table th:nth-child(4),.items-table td:nth-child(4){width:74px;}'
            . '.items-table th:nth-child(5),.items-table td:nth-child(5){width:92px;}'
            . '.items-table th:nth-child(6),.items-table td:nth-child(6){width:90px;}'
            . '.items-table th:nth-child(7),.items-table td:nth-child(7){width:68px;}'
            . '.items-table th:nth-child(8),.items-table td:nth-child(8){width:96px;}'
