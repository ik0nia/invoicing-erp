...
class ContractTemplateVariables
{
    ...
    public function listPlaceholders(): array
    {
        return [
            ...
            ['key' => 'annex.title', 'label' => 'Generator anexe suplimentare - denumire anexa'],
            ['key' => 'annex.content', 'label' => 'Generator anexe suplimentare - continut editabil (HTML simplu)'],
            ['key' => 'annex.signature', 'label' => 'Generator anexe suplimentare - semnatura preset (HTML img)'],
