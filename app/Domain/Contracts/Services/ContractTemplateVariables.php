...
class ContractTemplateVariables
{
    ...
    public function listPlaceholders(): array
    {
        return [
            ...
            ['key' => 'annex.title', 'label' => 'Generator anexa furnizor - denumire anexa'],
            ['key' => 'annex.content', 'label' => 'Generator anexa furnizor - continut editabil (HTML simplu)'],
            ['key' => 'annex.signature', 'label' => 'Generator anexa furnizor - semnatura preset (HTML img)'],
