...
$router->get('/admin/incasari/extras/brut', [PaymentsController::class, 'bankStatementRaw']);
...
$router->get('/admin/incasari/repair-orphans', [PaymentsController::class, 'repairOrphanBankTransactions']);
